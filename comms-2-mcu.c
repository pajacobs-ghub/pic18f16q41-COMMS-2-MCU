...
{   
    ...
    //
    // Use RA4(out),RA5(in) to buffer SPICLK from Pico2
    //
    ANSELAbits.ANSELA4 = 0;
    LATAbits.LATA4 = 0;
    TRISAbits.TRISA4 = 0; // output to MCP3301
    ANSELAbits.ANSELA5 = 0;
    TRISAbits.TRISA5 = 1; // input from Pico2
    // Use CLC2 to reflect RA5 onto RA4.
